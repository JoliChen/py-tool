...
add options:
    -w, --weak                     Add the weak flag when libraries or framework are added. Linking optional.
    -E, --no-embed                 Do not embed framework when added.
    -s, --sign-on-copy             Sign framework when copied/embedded.
