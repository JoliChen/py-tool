...
class PBXGenericTarget(PBXGenericObject):
    ...
    def get_build_phases(self, build_phase_type, search_parameters=None):
        result = []
        ...
        for build_phase_id in self.buildPhases:
            ...
            if current_build_phase == build_phase_type and \
                    all(key in target_build_phase and target_build_phase[key] == search_parameters[key] for key in
                        search_parameters):
